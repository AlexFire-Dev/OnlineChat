...
urlpatterns = [
    ...
    path('guild/<int:guild>/change/channels/', login_required(GuildChangeChannelsView.as_view()), name='guild-change-channels'),
    path('guild/<int:guild>/change/channels/create/', login_required(ChannelCreateView.as_view()), name='channel-create'),
    path('guild/<int:guild>/change/channels/<int:channel>/delete/', login_required(DeleteChannel.as_view()), name='channel-delete'),
